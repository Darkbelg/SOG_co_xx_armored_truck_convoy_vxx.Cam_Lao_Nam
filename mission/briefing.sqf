...
if (side group player != CIVILIAN) then {
	...
	<br/>Our convoy is transporting fuel to FOB2 Kon Tum.
	<br/>
	<br/><font size='18' color='#80FF00'>SPECIAL TASKS</font>
	<br/>Drive the convoy to the FOB. Make sure at least 2 of the 5 fuel trucks arrive.
	<br/>If you get into contact you should try to push through. Follow the black arrows stay on the designated road.
	<br/>Drive in staggered column so you can drive fast and help prevent some classic arma dysnc.
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>We have no support. If there are any changes in the plan high command will inform us.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Forces are vietnamese. We are not sure how many or where the ambushes will be set. But there will be ambushes.
	<br/>
